...
class PatchedDecoderFinetuneModel(nn.Module):
    """Finetuning model class for the patched time-series decoder using PyTorch."""

    def __init__(self, core_layer_tpl, freq=0):
        super(PatchedDecoderFinetuneModel, self).__init__()
